...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"scripts.js":[function(require,module,exports) {
var define;
"use strict";
...
var apiKey = "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";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          prompt = "Respond as a bored cow: ".concat(input.value);
          params = {
          ...
          client.post("https://api.openai.com/v1/completions", params).then(function (result) {
            response.style.backgroundColor = "white";
            response.innerHTML = "<p>".concat(result.data.choices[0].text, "</p>");
